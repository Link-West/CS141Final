...
//method to create a randomized volume object to manipulate -- scrapped, see notes in main
/*    public static void rand()throws Exception{
        System.out.println("Random number from 0 to 1000 to convert:");
        Random y = new Random();
        double x = y.nextDouble(); //L: changed value into a double
        Volume randomizedVol = new Volume(x, "l");
    }*/
    public static void listUnits() {
        ...
        System.out.println("Metric Units of Volume"); //L: changed distance to volume
    ...
    public double toCML() { //L: All of these used x-to-cm rather than to-cml
        if (this.unit_of_measurement.equals("ts")) {
            return tstocml(this.value);
        } else if (this.unit_of_measurement.equals("tbs")) {
            return tbstocml(this.value);
        } else if (this.unit_of_measurement.equals("oz")) {
            return oztocml(this.value);
        } else if (this.unit_of_measurement.equals("c")) {
            return ctocml(this.value);
        } else if (this.unit_of_measurement.equals("p")) {
            return ptocml(this.value);
        } else if (this.unit_of_measurement.equals("q")) {
            return qtocml(this.value);
        } else if (this.unit_of_measurement.equals("g")) {
            return gtocml(this.value);
        } else if (this.unit_of_measurement.equals("ml")) {
            return mltocml(this.value);
        } else if (this.unit_of_measurement.equals("l")) {
            return ltocml(this.value);
        } else if (this.unit_of_measurement.equals("cml")) {
            return cmltocml(this.value);
        }  else if (this.unit_of_measurement.equals("cc")) {
            return cctocml(this.value);
        }  else if (this.unit_of_measurement.equals("cm")) {
            return cmtocml(this.value);
        } else System.out.println("This unit of measurement is not recognized.");
        return 0.0;
    }
    public double toCC() {
